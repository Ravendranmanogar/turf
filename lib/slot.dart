...
class _SlotSelectionPageState extends State<SlotSelectionPage> {
  ...
  Future<void> saveBookingData(String selectedLocation, String selectedTurf) async {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //appBar: AppBar(title: const Text('Select Timing and Session')),
      body:  Container(
            ...
            child: Center(
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    const Center(child: Text('Select Timing and Session',style: TextStyle(color: Colors.black,fontSize: 25,fontWeight: FontWeight.bold),),),
                    ...
                    Center(
                      child: ElevatedButton(
                        onPressed: () {
                          if (selectedTiming != null && selectedSession != null) {
                            saveBookingData(selectedLocation, selectedTurf); // Save booking data to Firestore
